app.controller('SportRadarCtrl', ['$scope' , '$http',function ($scope,$http ) {
  ...
  $http({method: 'GET', url: 'http(s)://api.sportradar.us/golf-t1/leaderboard/pga/2015/tournaments/tourid/leaderboard-v1.0.json?api_key=rwppn9ub7aqmde94djw23ggm'}).success(function(sportsData){
